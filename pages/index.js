...
const btnLivre = { marginRight: 4, padding: '4px 12px', cursor: 'pointer', border: '1px solid #28a745', borderRadius: 4, background: '#d4edda', color: '#155724', fontWeight: 700, fontSize: '1rem' }
